...
export async function mockFreighter(page: Page, publicKey = "GCFM4VENDOR8TESTING1234567890ABCDEF", signedTransaction = "signed-challenge-xdr") {
  await page.addInitScript(
    ({ pubKey, signedTx }) => {
      ...
      window.addEventListener('message', (e: MessageEvent) => {
        ...
        if (type === 'REQUEST_NETWORK_DETAILS') respond({ networkDetails: { network: "TESTNET", networkUrl: "", networkPassphrase: "Test SDF Network ; September 2015" } });
